    ...
    return(
       <div>
            ...
            <form onSubmit={(e)=>e.preventDefault()}className="h-[50%]  md:h-[72%] w-full md:w-3/12 absolute bg-black p-12 mx-auto left-0 right-0 my-36 text-white bg-opacity-80 rounded-lg">
                ...
                <input ref={password} type="password" placeholder="Password" className="relative -top-5 md:-top-5 md:relative p-1.5 md:p-3 my-1 md:my-1 w-full rounded-lg bg-gray-700 "/>
